...
function Slide1() {
  ...
  return (
    <View style={styles.hero}>
      ...
      <Text style={styles.heroTitle}>Qual é o seu nome?</Text>
      <Text style={styles.heroSubtitle}>
        Aprenda a perguntar e responder nomes em inglês
      </Text>
...
function Slide2() {
  ...
  return (
    <View style={styles.slide}>
      <Text style={styles.slideObjectiveTitle}>What's your name?</Text>
      <Text style={styles.slideObjectiveSubtitle}>Qual é o seu nome?</Text>
...
function Slide3() {
  ...
  return (
    <View style={styles.slide}>
      <Text style={styles.slideObjectiveTitle}>My name is...</Text>
      <Text style={styles.slideObjectiveSubtitle}>Meu nome é...</Text>

      <View style={styles.objectiveRow}>
        <Text style={styles.objectiveRowText}>Resposta Formal</Text>
      </View>

      <View style={styles.tipCard}>
        <Text style={styles.tipText}>💡 Exemplo: "My name is Maria."</Text>
      </View>
      ...
      >
        <Text style={styles.listenButtonText}>🔊 Ouvir exemplo</Text>
      </TouchableOpacity>
...
function Slide4() {
  ...
  return (
    <View style={styles.slide}>
      <Text style={styles.slideObjectiveTitle}>I'm...</Text>
      <Text style={styles.slideObjectiveSubtitle}>Eu sou...</Text>

      <View style={styles.objectiveRow}>
        <Text style={styles.objectiveRowText}>Forma Mais Natural</Text>
      </View>
...
function Slide5() {
  ...
  const options = ["Hello", "Nice to meet you", "My name is Ana"];
  const correctAnswer = ["My name is Ana"];
  ...
  return (
    <View style={styles.slide}>
      <Text style={styles.questionTitle}>
        Alguém pergunta: What's your name?
      </Text>
      <Text style={styles.questionTitle}>Escolha a resposta:</Text>
      ...
      {isCorrect && (
        <View style={styles.successBox}>
          ...
          <Text style={styles.successText}>
            "My name is Ana" é a resposta perfeita! As outras opções são
            cumprimentos, não respondem à pergunta sobre o nome.
          </Text>
        </View>
      )}
...
function Slide6() {
  ...
  const options = ["My name is Carlos", "Hello Carlos", "I'm Carlos"];
  const correctAnswer = ["I'm Carlos"];
  ...
  return (
    <View style={styles.slide}>
      <Text style={styles.questionTitle}>
        Qual é a forma MAIS NATURAL de dizer seu nome?
      </Text>
      ...
      {isCorrect && (
        <View style={styles.successBox}>
          <Text style={styles.successTitle}>✓ Correto!</Text>
          <Text style={styles.successText}>
            "I'm Carlos" é mais natural e usado no dia a dia! "My name is"
            também está correto, mas é mais formal.
          </Text>
        </View>
      )}
...
function Slide7() {
  ...
  const options = ["How are you?", "What are you?", "What's your name?"];
  const correctAnswer = ["What's your name?"];
  ...
  return (
    <View style={styles.slide}>
      <Text style={styles.questionTitle}>
        Como você pergunta "Qual é o seu nome?" em inglês?
      </Text>
      ...
      {isCorrect && (
        <View style={styles.successBox}>
          <Text style={styles.successTitle}>✓ Correto!</Text>
          <Text style={styles.successText}>
            "What's your name?" é a forma correta! "How are you?" significa
            "Como você está?" e "What are you?" significa "O que você é?"
          </Text>
        </View>
      )}
...
function Slide8() {
  ...
  const options = ["Sandra", "Sarah", "Sam"];
  const correctAnswer = "Sarah";
    ...
    <View style={styles.slide}>
      ...
      {isCorrect && (
        <View style={styles.successBox}>
          <Text style={styles.successTitle}>✓ Correto!</Text>
          <Text style={styles.successText}>
            Excelente audição! A pessoa disse "I'm Sarah" - o nome é Sarah!
          </Text>
        </View>
      )}
...
function Slide9() {
  ...
  const options = ["Your", "His", "My"];
  const correctAnswer = ["My"];
    ...
    <View style={styles.slide}>
      ...
      {isCorrect && (
        <View style={styles.successBox}>
          <Text style={styles.successTitle}>✓ Correto!</Text>
          <Text style={styles.successText}>
            "My name is Pedro" está perfeito!{"\n"}"My" = "Meu/Minha".
          </Text>
        </View>
      )}
...
function Slide10() {
  ...
  const options = ["Hi, Lucas!", "My name is Lucas Silva.", "I'm Lucas."];
  const correctAnswer = ["My name is Lucas Silva."];
  ...
  return (
    <View style={styles.slide}>
      <Text style={styles.questionTitle}>
        Você está em uma entrevista de emprego. Como você deve dizer seu nome?
      </Text>
      ...
      {isCorrect && (
        <View style={styles.successBox}>
          <Text style={styles.successTitle}>✓ Correto!</Text>
          <Text style={styles.successText}>
            Perfeito! Em situações formais (entrevistas, reuniões
            profissionais), é melhor usar "My name is" com nome completo!
          </Text>
        </View>
      )}
...
function Slide11() {
  ...
  return (
    <View style={styles.slide}>
      <Text style={styles.questionTitle}>🗣️ Prática de Pronúncia</Text>

      {/* Card da frase */}
      <View style={styles.speakCard}>
        <Text style={styles.speakPhrase}>"What's your name?"</Text>
        <Text style={styles.speakHint}>
          📢 Responda em voz alta com SEU nome!
        </Text>
      </View>
      ...
      <TouchableOpacity style={styles.modelButton} onPress={speakModel}>
        <Text style={styles.modelButtonText}>🔊 Ouvir pergunta</Text>
      </TouchableOpacity>
    ...
    <View style={styles.slide}>
      ...
      <View style={styles.successCard}>
        ...
        <View style={styles.successItem}>
          <Text>✅</Text>
          <Text style={styles.successItemText}>Perguntar o nome de alguém</Text>
        </View>

        <View style={styles.successItem}>
          <Text>✅</Text>
          <Text style={styles.successItemText}>Responder de forma natural</Text>
        </View>

        <View style={styles.successItem}>
          <Text>✅</Text>
          <Text style={styles.successItemText}>
            Usar em diferentes situações
          </Text>
        </View>

        <View style={styles.successItem}>
          <Text>✅</Text>
          <Text style={styles.successItemText}>Pronunciar corretamente</Text>
        </View>
      </View>
