...
Se estiver com um filho pequeno: "One adult and one child, please." Simples e direto!`,
  ...
  },
  {
    ...
    activity: {
      ...
      audioText: "One adult, please.",
      audioDurationMs: 1500,
      statement: "O turista do áudio está pedindo um ingresso para uma criança.",
      options: ["true", "false"],
      correctAnswer: "false",
      successTitle: "Correto",
  ...
  },
  {
    ...
    activity: {
      ...
      options: ["I want enter.", "One adult ticket, please.", "Give me one adult."],
