...
import ex1 from "../../../../exc/ex1";
import ex2 from "../../../../exc/ex2";
import ex3 from "../../../../exc/ex3";
import ex4 from "../../../../exc/ex4";
import ex5 from "../../../../exc/ex5";
import ex6 from "../../../../exc/ex6";
import ex7 from "../../../../exc/ex7";
import ex8 from "../../../../exc/ex8";
import ex9 from "../../../../exc/ex9";
import ex10 from "../../../../exc/ex10";
import ex11 from "../../../../exc/ex11";
import ex12 from "../../../../exc/ex12";
import ex13 from "../../../../exc/ex13";
import ex15 from "../../../../exc/ex15";
import ex14 from "../../../../exc/ex14";
import ex16 from "../../../../exc/ex16";
...
const STORAGE_KEY = "@curso_progress_travel_A1";
...
export default function createBusinessLessonScreen(lessonSlides) {
  const LESSON_SLIDES = lessonSlides;
  const SLIDE_COUNT = LESSON_SLIDES.length;
  const EXERCISE_SLIDE_COUNT = LESSON_SLIDES.filter(
    (slide) => slide.type !== "finish",
  ).length;

  return function BusinessLessonScreen({ route, navigation }) {
    ...
    const lessonAccuracy = completedExerciseScores.length
      ? Math.round(
          completedExerciseScores.reduce((sum, score) => sum + score, 0) /
            Math.max(EXERCISE_SLIDE_COUNT, 1),
        )
    ...
    const goToNextLesson = async () => {
      navigation.replace("TravelEnglish", {
