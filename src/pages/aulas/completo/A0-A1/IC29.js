...
const LESSON_SLIDES = [
  ...
  },
  {
    ...
    activity: {
      ...
      content: [
        ...
        "Ao dizer P (pê), o papel deve se mexer com o sopro!",
        "Ao dizer B (bê), o papel quase não se mexe, mas você sente sua garganta vibrar.",
      ],
      continueLabel: "Continuar",
    },
  },
  ...
  },
  {
    ...
    activity: {
      label: "Tip",
      content: [
        "Para o V (vê), encoste os dentes de cima no lábio de baixo, como um motorzinho: vvvvv.",
  ...
  },
  {
    component: Exercise1,
    activity: {
      prompt: "Conecte a letra é sua característica",
      pairs: [
  ...
  },
  {
    ...
    activity: {
      ...
      successTitle: "Correto",
      successMessage: 'Resposta esperada: "bê - vê - pê".',
    },
  },
  {
    key: "lesson-finish",
...
export default function IC29({ route, navigation }) {
