...
const LESSON_SLIDES = [
  {
    ...
    activity: {
      ...
      questions: [
        {
          image: Images.ex10,
          question: 'Como você diz "Eu sou o Kaique" de forma curta?',
        ...
        {
          image: Images.ex10,
          question: 'Qual destas é uma "Mini Bio" de 1 frase correta?',
          options: [
...
export default function IC43({ route, navigation }) {
