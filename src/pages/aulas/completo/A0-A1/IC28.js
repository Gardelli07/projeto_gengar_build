...
const LESSON_SLIDES = [
  ...
  },
  {
    ...
    activity: {
      ...
      pairs: [
        { en: "Ethan (US)", pt: "í-tê-êitch-êi-én" },
        { en: "Harrison (UK)", pt: "êitch-êi-ár-ár-ái-és-ôu-én" },
        { en: "Imogen (UK)", pt: "ái-ém-ôu-djii-í-én" },
      ],
      successTitle: "Excelente",
      successMessage:
        "Ethan = í-tê-êitch-êi-én, Harrison = êitch-êi-ár-ár-ái-és-ôu-én, Imogen = ái-ém-ôu-djii-í-én.",
    },
  },
  {
    component: Exercise6,
...
export default function IC28({ route, navigation }) {
