...
const LESSON_SLIDES = [
  ...
  },
  {
    ...
    activity: {
      ...
      image: IC.A7S1,
      audioSource: require("../../../../mp3/IC/A7S1.mp3"),
  ...
  },
  {
    ...
    activity: {
      label: "Tip",
      content: [
        `Dica do Camaleão: Ninguém fala 'I am' o tempo todo. Na vida real, os nativos grudam as palavras: I am vira I'm. Soa muito mais fluído! 🦎✨`,
      ],
      continueLabel: "Continuar",
    },
  },
  ...
  },
  {
    ...
    activity: {
      prompt: "Escute e complete",
      image: IC.A7S5,
      audioSource: require("../../../../mp3/IC/A7S5.mp3"),
      audioDurationMs: 1000,
...
export default function IC07({ route, navigation }) {
