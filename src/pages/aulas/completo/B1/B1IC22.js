...
Both express prohibition, but mustn't tends to be more formal or rules-based.`,
  ...
  },
  {
    ...
    activity: {
      ...
      audioText:
        "In a library, you mustn't make noise or use your phone. You also can't eat or drink inside.",
      audioLanguage: "en-GB",
  ...
  },
  {
    ...
    activity: {
      ...
      audioText: "You can't enter this area without a security pass.",
      audioLanguage: "en-US",
...
export default function B1IC22({ route, navigation }) {
