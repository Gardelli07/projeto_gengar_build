...
Essas estruturas sempre vêm acompanhadas do verbo no particípio!`,
      ],
  ...
  },
  {
    ...
    activity: {
      ...
      audioText: "Someone must have left the door open.",
      audioDurationMs: 3300,
      statement:
        "The speaker is 100% sure they saw someone open the door.",
      options: ["true", "false"],
      correctAnswer: "false",
  ...
  },
  {
    ...
    component: Exercise4,
    activity: {
      prompt: "É uma leve possibilidade (Might). Qual a frase correta?",
      image: ICB1.A37S3,
  ...
  },
  {
    ...
    activity: {
      ...
      successTitle: "Correto",
      successMessage: "Must have indica uma dedução forte baseada em evidência.",
    },
  },
  {
    key: "certainty-match",
    ...
    activity: {
      ...
      pairs: [
        { en: "Must have", pt: "Quase certeza (Dedução)" },
  ...
  },
  {
    ...
    component: Exercise7,
    activity: {
      prompt: "Ordene a história de especulação clicando nas frases.",
      options: [
  ...
  },
  {
    ...
    activity: {
      ...
      audioText: "She might have missed the train.",
  ...
  },
  {
    ...
    activity: {
      ...
      helperText: "Use must have para dedução forte e might have para possibilidade.",
      submitLabel: "Enviar",
      successTitle: "Correto",
...
export default function B1IC37({ route, navigation }) {
