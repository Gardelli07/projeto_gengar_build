...
const LESSON_SLIDES = [
  {
    ...
    activity: {
      ...
      content: [
        `E se você quisesse perguntar a alguém sobre uma situação imaginária?
...
Vamos aprender a fazer essas perguntas!`,
  ...
  },
  {
    ...
    component: Exercise4,
    activity: {
      prompt: "Qual é a forma correta de fazer a pergunta?",
      image: ICB1.A19S2p1,
...
export default function B1IC13({ route, navigation }) {
