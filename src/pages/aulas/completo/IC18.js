...
const LESSON_SLIDES = [
  {
    ...
    activity: {
      ...
      content: [
        IC.A18S1,
        IC.A18S1p2,
        "O sol mudou de posição, e o seu cumprimento também muda! Vamos aprender a saudar o dia?",
      ],
  ...
  },
  {
    ...
    activity: {
      ...
      image: IC.A18S2,
      audioSource: require("../../../../mp3/IC/A18S2.mp3"),
  ...
  },
  {
    ...
    activity: {
      prompt: "Escute e escolha",
      image: IC.A18S4,
      audioSource: require("../../../../mp3/IC/A18S4.mp3"),
  ...
  },
  {
    ...
    activity: {
      label: "Tip",
      content: [
        "Quando muda? O Good afternoon comeca exatamente após o meio-dia (12:00 PM) e vai até o pôr do sol, por volta das 5 ou 6 da tarde.",
  ...
  },
  {
    ...
    activity: {
      ...
      audioSource: require("../../../../mp3/IC/A18S7.mp3"),
      audioDurationMs: 1000,
  ...
  },
  {
    component: Exercise6,
    activity: {
      prompt: "Voce chega no trabalho ás 9 da manhã.",
  ...
  },
  {
    ...
    activity: {
      ...
      content: [
        ...
        "Próxima aula: O misterio do Good Evening vs Good Night. See you!",
      ],
      continueLabel: "Continuar",
    },
  },
...
export default function IC18({ route, navigation }) {
