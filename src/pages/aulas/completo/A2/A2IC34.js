...
const LESSON_SLIDES = [
  ...
  },
  {
    ...
    activity: {
      ...
      scrambledWords: ["place", "to", "What's", "best", "the", "sunset", "see", "the", "?"],
      words: ["place", "to", "What's", "best", "the", "sunset", "see", "the", "?"],
  ...
  },
  {
    ...
    activity: {
      ...
      audioText: "What's the best place to buy a camera?",
  ...
  },
  {
    ...
    activity: {
      ...
      audioText: "What's the best place to eat sushi?",
  ...
  },
  {
    ...
    activity: {
      ...
      instruction: 'Se um turista perguntasse "What\'s the best place to eat?", o que você responderia?',
