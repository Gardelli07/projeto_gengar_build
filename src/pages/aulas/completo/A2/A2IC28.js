...
const LESSON_SLIDES = [
  ...
  },
  {
    ...
    activity: {
      ...
      audioText: "I was cooking when he arrived.",
      options: ["I was cooking when he arrived.", "Cooked when he was arriving."],
      correctAnswer: "I was cooking when he arrived.",
      correctOption: "I was cooking when he arrived.",
      feedbackMessage: "A ação que já estava rolando leva ing; a interrupção fica no Past Simple.",
  ...
  },
  {
    ...
    activity: {
      ...
      audioText: "We were playing when it started to rain.",
      options: ["We were play when it started to rain.", "We were playing when it started to rain."],
  ...
  },
  {
    ...
    activity: {
      ...
      blanks: [
        { id: "1", options: ["were dancing", "danced"], answer: "were dancing" },
        { id: "2", options: ["was stopping", "stopped"], answer: "stopped" },
        { id: "3", options: ["was looking", "looked"], answer: "looked" },
      ],
      successTitle: "Correto",
      successMessage: "Ação longa com were dancing; interrupções no passado simples.",
    },
  },
  {
    key: "a2ic28s6",
    ...
    activity: {
      ...
      scrambledWords: ["sleeping", "I", "was", "when", "rang", "phone", "the", "."],
  ...
  },
  {
    ...
    activity: {
      ...
      scrambledWords: ["Cam", "was", "eating", "when", "he", "saw", "a", "fly", "."],
  ...
  },
  {
    ...
    activity: {
      ...
      scrambledWords: ["They", "were", "walking", "when", "it", "started", "to", "snow", "."],
      words: ["They", "were", "walking", "when", "it", "started", "to", "snow", "."],
  ...
  },
  {
    ...
    activity: {
      ...
      audioText: "She was singing when I entered the room.",
  ...
  },
  {
    ...
    activity: {
      ...
      audioText: "We were driving when the car broke down.",
  ...
  },
  {
    ...
    activity: {
      ...
      audioText: "Was he working when you called?",
  ...
  },
  {
    ...
    activity: {
      ...
      instruction: 'Grave esta frase dramática: "I was dreaming about pizza when the alarm clock woke me up!"',
